...
spx_ctx ctx = {
    { 0x1a, 0x3d, 0x9c, 0x1c, 0x1e, 0x6c, 0xd4, 0xa4, 
      0xbe, 0xbe, 0x2c, 0x60, 0x30, 0x84, 0x04, 0xe4, 
      0xa3, 0x50, 0xa8, 0x7e, 0xf4, 0x47, 0xe4, 0x9a, 
      0xa7, 0xee, 0x50, 0x61, 0x13, 0x1b, 0xab, 0x63 },
    { 0x07, 0xad, 0x58, 0xd9, 0xa7, 0xb1, 0xf8, 0x56, 
...
unsigned char sig[EXP_SIG_BYTES]  = { 0xa1, 0xb2, 0xc3, 0xd4, 0xe5, 0xf6, 0xf7, 0x00 };
...
uint8_t get_root(uint8_t* m, uint8_t len)
{
    size_t i = 0;
    for (i=0; i<SPX_N; ++i)
    {
...
uint8_t test_putch(uint8_t* m, uint8_t len)
{
    putch('S');
    putch('P');
    putch('H');
